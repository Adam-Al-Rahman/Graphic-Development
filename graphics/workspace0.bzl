""" Graphics workspace initialization. Consult the WORKSPACE on how to use it."""
...
load("//third_party/glfw:workspace.bzl", glfw = "repo")
load("//third_party/glm:workspace.bzl", glm = "repo")
...
def workspace():
    """ workspace of the graphics folders """
